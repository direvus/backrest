    ...
    foreach my $strBackup (@stryBackup)
    {
        if ($strBackup ne OPTION_DEFAULT_RESTORE_SET)
        {
            ...
            my $oBackupHash =
            {
                ...
                &MANIFEST_KEY_ARCHIVE_START => $oManifest{&MANIFEST_SECTION_BACKUP}{&MANIFEST_KEY_ARCHIVE_START},
                &MANIFEST_KEY_ARCHIVE_STOP => $oManifest{&MANIFEST_SECTION_BACKUP}{&MANIFEST_KEY_ARCHIVE_STOP},
